...
export const api = {
  ...
  updateTrack: async (id: number, data: { name: string, gates: string, coordinates: string }) => {
    // Added the /api/ prefix to match your Hono backend routes
    const response = await axios.put(`${API_URL}/tracks/${id}`, data);
