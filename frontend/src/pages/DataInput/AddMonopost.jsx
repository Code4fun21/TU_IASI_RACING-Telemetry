...
import { createMonopost } from "../../api/monoposts.routes";

export default function AddMonopost({ open, setOpen }) {
    // const [open, setOpen] = useState(true);
    const handleSubmit = (event) => {
        createMonopost({
            name: event.target["monopost-name"].value,
                                    ...
                                    <div className="bg-indigo-700 px-4 py-6 sm:px-6">
                                        ...
                                        <div className="mt-1">
                                            <p className="text-sm text-indigo-300">
                                                Get started by filling in the information below to create a new monopost
                                                configuration.
                                            </p>
                                        </div>
                                    </div>
...
AddMonopost.defaultProps = {
    open: false, // Default value for the 'open' prop
    setOpen: () => {}, // Default no-op function for 'setOpen'
};
