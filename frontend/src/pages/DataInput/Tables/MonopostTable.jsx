...
const people = [
    { name: "monopost", tires: "32", details: "lfeaw", other: "lfeaw" },
    { name: "monopost", tires: "32", details: "lfeaw", other: "lfeaw" },
    { name: "monopost", tires: "32", details: "lfeaw", other: "lfeaw" },
    { name: "monopost", tires: "32", details: "lfeaw", other: "lfeaw" },
    { name: "monopost", tires: "32", details: "lfeaw", other: "lfeaw" },
...
export default function MonopostsTable() {
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            <AddMonopost open={open} setOpen={setOpen} />
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold text-gray-900">Monoposts</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the monoposts including their name, tires, details and other information. You can
                        add, edit or delete monoposts as needed.
                    </p>
                </div>
